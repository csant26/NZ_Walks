...
namespace NZWalks_API.Migrations
{
    ...
    [Migration("20240919041806_add images")]
            ...
            modelBuilder.Entity("NZWalks_API.Models.Domain.Difficulty", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f4786332-349d-4e72-a3bc-950433a404a1"),
                            Name = "Hard"
                        },
                        new
                        {
                            Id = new Guid("62a8036d-628a-4e80-a761-f8ebd946ea68"),
                            Name = "Medium"
                        },
                        new
                        {
                            Id = new Guid("fd53e928-9668-4aa0-9ff6-c690edb8af98"),
                            Name = "Easy"
                        });
                });

            modelBuilder.Entity("NZWalks_API.Models.Domain.Image", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
